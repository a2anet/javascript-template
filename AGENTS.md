...
Add high-level coding guidelines and review notes to this file. Specific actionable items from code reviews should be captured here for the JavaScript implementation.
...
- JavaScript template changes should preserve the `bun`, `biome`, and `typescript` workflow.
